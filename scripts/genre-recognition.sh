...
python $SOURCEDIR/classifier/train.py --csv_file $SLURM_TMPDIR/data/csv/csv_discogs/final_all_classes_discogs.csv --directory $SLURM_TMPDIR  --img_width 250 --img_height 250 --balance_type "none"
