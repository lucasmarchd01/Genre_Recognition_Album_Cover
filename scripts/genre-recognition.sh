...
python $SOURCEDIR/classifier/train.py --csv_file $SLURM_TMPDIR/data/csv/csv_msd/unique_art_final.csv --directory $SLURM_TMPDIR  --img_width 200 --img_height 200 --balance_type "downsampling"
